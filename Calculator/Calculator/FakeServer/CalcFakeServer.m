...
#import "CalcFakeServer.h"
#import <GCDWebServers/GCDWebServers.h>

@interface CalcFakeServer() <GCDWebServerDelegate>

@property (nonatomic, strong) GCDWebServer *server;

@end

@implementation CalcFakeServer

static CalcFakeServer* _instance = nil;

+ (instancetype)shared {
	if (!_instance) {
		static dispatch_once_t onceToken;
		dispatch_once(&onceToken, ^{
			_instance = [[CalcFakeServer alloc] init];
